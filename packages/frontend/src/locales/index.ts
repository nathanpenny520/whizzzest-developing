...
const messages = {
  'zh-CN': {
    ...
    admin: {
      pageTitle: '管理后台',
      loading: '加载中...',
      tabs: { merchants: '商户审核', coupons: '优惠券管理', knowledge: '知识库', stats: '用户统计' },
      verified: '已通过',
      pending: '待审核',
      approve: '通过',
      revoke: '撤销',
    ...
    aiChat: {
      title: '花傩',
      subtitle: '傩文化守护灵',
      welcome: '傩愿与你相遇！我是花傩，万载的AI守护灵～可以带你了解烟花文化、非遗传承、美食特产、旅游线路……有什么想知道的尽管问我！',
      placeholder: '请输入您的问题...',
      quickQ1: '🔥 万载烟花有什么特别的？',
      quickQ2: '🏛️ 带我去看非遗文化～',
  ...
  'en': {
    ...
    admin: {
      ...
      loading: 'Loading...',
      tabs: { merchants: 'Merchants', coupons: 'Coupons', knowledge: 'Knowledge', stats: 'Statistics' },
      verified: 'Verified',
      pending: 'Pending',
      approve: 'Approve',
      revoke: 'Revoke',
    ...
    firework: {
      ...
      saveDialog: {
        ...
        description: 'Saves all engine settings and recorded timeline, generates a share link for others to watch the replay',
      ...
      longExposureHint: 'Particle trails persist longer, ideal for screenshots. Best with background image',
    ...
    aiChat: {
      ...
      welcome: 'Nuo blessings upon you! I\'m Hua Nuo, Wanzai\'s AI guardian spirit~ I can show you fireworks culture, heritage, food, travel routes... Ask me anything!',
