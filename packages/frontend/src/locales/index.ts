...
const messages = {
  'zh-CN': {
    ...
    nav: {
      ...
      about: '关于我们',
      clusterCulture: '万载风物',
      clusterInteractive: '互动体验',
      clusterBusiness: '商业服务',
      aiHuaNuo: 'AI 花傩',
      digitalFirework: '数字烟花',
      fireworkRankings: '烟花排行榜',
      miniGames: '小游戏',
      docs: '万载文库',
      merchantApply: '商户入驻',
    },
    ...
    culture: {
      ...
      sections: {
        fireworks: {
          title: '万载花炮',
          desc1:
            '万载花炮制作技艺在2008年6月入选第一批国家级非物质文化遗产扩展项目名录。万载花炮以响声好、响率高、有香味而驰名中外，从最初单一的响声效果，发展到如今声、色、烟、香、花等综合造型运用。',
          desc2:
            '万载烟花的历史可以追溯到唐代，盛于宋代，历经千年发展。清道光年间，万载烟花爆竹已经"通行南北，商贾络绎"；光绪年间，当地"男妇大小均借此以资工作"，产品质高价廉，销至广东、福建等省。',
          desc3:
            '如今，万载花炮共有4000多个规格品种，涵盖鞭炮、玩具烟花、组合烟花等9大类，产品畅销全国，远销欧、美、东南亚等40多个国家和地区。',
        },
        deshenggu: {
          title: '得胜鼓',
          desc1:
            '得胜鼓是万载县的传统民间鼓乐，起源于北宋，主要取材于唐朝平定"安史之乱"的历史事件。得胜鼓以其雄浑激越的气势、整齐划一的节奏和丰富多彩的表演形式而闻名。',
          desc2:
            '得胜鼓通常由数十人组成表演队伍，使用大鼓、小鼓、唢呐、锣、钹等乐器，表演时队形变幻多样，鼓点节奏明快，充分展现了万载人民的豪迈气概和团结精神。',
          desc3:
            '如今，得胜鼓已成为万载县重要的文化品牌，经常在各类文化活动和节日庆典中表演，深受群众喜爱。',
        },
        kaiKouNuo: {
          title: '万载开口傩',
          desc1:
            '万载开口傩，又称"跳魈"，是当地民间驱鬼逐疫、祈福求安、娱神娱人的极具特色的民俗文化活动，起源于元末明初，距今已有600余年历史。',
          desc2:
            '开口傩不同于其他傩舞形式，它每角必唱，可谓唱、做、念、打齐全，但以唱为主，音乐则以打击乐贯穿始终，保留着古朴的乡土气息。',
          desc3: '2008年6月，"万载开口傩"入选第二批国家级非物质文化遗产名录。',
        },
        xiaBu: {
          title: '夏布织造',
          desc1:
            '夏布织造技艺是万载县的传统手工技艺，其生产可追溯溯源至东晋后期，距今已有1600余年历史。2009年，万载夏布织造技艺被列入第三批国家级非物质文化遗产名录。',
          desc2:
            '万载夏布以苎麻为原料，经过经纱、刷浆、上机、织造四道工序。夏布质地轻薄、透气性好、吸汗性强，是夏季理想的服装面料。',
          desc3: '如今，万载夏布已成为江西省的特色产品，远销海内外，深受消费者喜爱。',
        },
        zhiPeng: {
          title: '纸棚山歌',
          desc1:
            '纸棚山歌是万载县的传统民间音乐，起源于明代，距今已有500多年的历史。纸棚山歌是表芯纸制作工人在劳动过程中创作的歌谣，内容丰富，形式多样。',
          desc2:
            '山歌内容围绕采竹、沤竹、焙纸等造纸工序展开，融合劳作艰辛、男女情爱与丰收期盼等主题。歌曲旋律优美，节奏明快，具有浓郁的地方特色。',
          desc3:
            '2007年3月，纸棚山歌已被列入江西省非物质文化遗产名录，成为万载县重要的文化遗产之一。',
        },
      },
    },
    food: {
      ...
      sections: {
        ...
        fuGuiYouJuan: {
          title: '富贵油卷',
          desc1:
            '万载六大碗的头菜，又称"八宝油卷"，是万载待客的最高礼遇。选用猪肉、猪网油、笋干、马蹄等八种食材精制，以猪网油包裹肉馅，经蒸制而成。外皮软糯微脆，内馅鲜香醇厚，口感丰富有层次。承载着富贵发财、步步高升的美好寓意，是万载宴席中不可或缺的开篇佳肴，藏着当地人的热忱与期许。',
        },
        wanzaiZhaRou: {
          title: '万载扎肉',
          desc1:
            '源于明末清初的传统佳肴，类似宜春扣肉却独具万载特色。选用优质五花肉，经腌制、油炸、蒸制等多道工序制成，色泽晶莹红亮，油润光泽。肉质肥而不腻，瘦而不柴，醇香软糯，入口即化，每一口都饱含浓郁的酱香与油脂的醇香。寓意生活富足、红红火火，是万载宴席中彰显喜庆氛围的必备菜品。',
        },
        wanzaiZhaRou2: {
          title: '万载诈肉',
          desc1:
            '万载极具特色的"以米代肉"佳肴，打破主食与硬菜的界限。以本地米粉和新鲜猪肉为原料，经搅拌、蒸制等传统工艺制成，虽不含大量鲜肉，却满口肉香。口感软糯筋道，咸香适中，吸饱了肉汁与调料的精髓，不油不腻，老少皆宜。寓意五谷丰登、年年有余，是镌刻着万载农耕文化的特色美味。',
        },
        wanzaiKuaiYu: {
          title: '万载块鱼',
          desc1:
            '选用万载本地新鲜草鱼，切成大小均匀的块状，用酒娘和食盐腌制入味后，经油炸至金黄色，再上锅蒸制而成。外皮微脆，内里细嫩滑嫩，鲜香味浓，鱼刺软烂可食，无需担心卡喉。色泽金黄诱人，口感层次丰富，酒娘的醇香中和了鱼肉的腥味，更添风味。寓意顺心顺意、年年有余，是宴席上寓意美好的经典鱼类菜肴。',
        },
        kangLeSanHuangJi: {
          title: '康乐三黄鸡',
          desc1:
            '选用万载本地散养的康乐三黄鸡，兼具羽黄、爪黄、喙黄的鲜明特征。采用传统清炖工艺，不添加过多调料，最大程度保留鸡肉本味。成品汤清色亮，肉质细嫩紧实，皮滑不腻，鲜香味醇，营养十分丰富。寓意大吉大利、万事如意，既是宴席上的硬菜，也是滋养身心的佳品，尽显万载本土风味。',
        },
        qingDunHeiShanYang: {
          title: '清炖黑山羊',
          desc1:
            '万载六大碗中的滋补佳品，选用本地优质黑山羊为原料，经慢火清炖而成。汤色清亮透明，无丝毫膻味，肉质细嫩不柴，醇香四溢，入口即化。富含蛋白质和多种矿物质，是万载人冬至时节的传统补品。承载着三阳开泰、好运常来的吉祥寓意，每一口都是大自然的馈赠，暖身又暖心。',
        },
        luoChenZhaFen: {
          title: '罗城扎粉',
          desc1:
            '罗城扎粉是万载省级非遗美食，明时起源于泰溪河两岸，以本地早米为原料，经浸磨、扎制、日晒等传统工艺制成。粉条约2-3毫米粗，色白如银、柔韧爽滑，久煮不烂，猛火快炒后根根分明，裹着酱香与鲜辣，带着独特发酵微香，是万载宴席与家常的经典主食。',
        },
        wanzaiDuoRou: {
          title: '万载剁肉',
          desc1:
            '万载经典家常小炒，传承百年风味，选用本地现宰黑猪肉前槽部位，手工剁制入味，肥瘦比例恰到好处。经热油煸炒，搭配本地鲜椒、蒜苗爆炒，色泽红亮诱人。入口鲜嫩多汁，鲜辣交织，蒜香与肉香浓郁回甘，下饭十足。承载着万载人的乡愁，是街头巷尾的热门美味，尽显赣湘融合的鲜辣特色。',
        },
        wanzaiFanYa: {
          title: '万载番鸭',
          desc1:
            '万载本土特色家禽美食，选用本地散养的黑番鸭，瘦肉率高、肉质紧实。可采用红烧、清炖或子姜焖制等多种做法，最宜焖煮入味，成品香气浓郁，肉质细嫩不柴，无丝毫膻味，汤汁醇厚绵长。搭配本地鲜姜、蒜苗调味，吸饱酱汁后鲜香味浓，是万载人宴客、过节的必备硬菜，藏着最地道的乡土烟火气。',
        },
        wanzaiBaiHe: {
          title: '万载百合',
          desc1:
            '万载特色药食同源美食，选用本地种植千年的龙牙百合，以肥厚无渣的鳞茎为原料，可清炒、蒸制或制成羹品。成品色泽洁白，口感清甜脆嫩，自带百合独有的鲜香，不苦不涩，淀粉含量丰富，营养醇厚。承载着吉祥美满的寓意，既是家常餐桌上的清爽佳肴，也是滋养身心的天然补品，尽显万载农耕风味。',
        },
        biaoXinZhi: {
          title: '表芯纸',
          desc1:
            '万载三大特产之一的表芯纸，宋时便是核心产地，清代达生产鼎盛。以本地毛竹为原料纯手工制作，成品色淡黄、纤维细长，质嫩性韧且厚薄均匀，兼具吸水性强、耐拉易燃的特点，古时为万载富源之本，如今仍远销湘鄂及东南亚，是祭祀、民俗多用的传统名纸。',
        },
        nanSuanZaoGao: {
          title: '南酸枣糕',
          desc1:
            '万载地理标志产品南酸枣糕，以当地深山野生南酸枣为原料，无添加色素与食用胶，经传统熬制与现代低温工艺制作。糕体呈琥珀色，柔韧不粘牙，酸中带甜且果香浓郁，富含植物黄酮、天然果胶等营养，口感纯滑，是老少皆宜的天然健康伴手礼。',
        },
      },
    },
    industry: {
      ...
      sections: {
        history: {
          title: '历史传承',
          desc1:
            '万载烟花的历史可以追溯到唐代，盛于宋代，历经千年发展。据《万载县志》记载，清道光年间，万载烟花爆竹已经 "通行南北，商贾络绎"；光绪年间，当地 "男妇大小均借此以资工作"，产品销至广东、福建等省；清末民初，万载的烟花爆竹生产庄已有 400 余个，从业人员逾 3000 人，形成了产、供、销一条龙的产业体系。',
          desc2:
            '在近代，万载烟花也留下了辉煌的印记：1936 年 4 月，江西省举办运杭展览会，万载送去的 "同心茂""振生万" 爆竹均获浙赣特产联合会奖状；北京奥运会、上海世博会、首都国庆庆典等重要盛会，都闪耀着万载花炮的璀璨光影。',
        },
        currentStatus: {
          title: '产业现状',
          scale: '产业规模',
          scaleDesc1:
            '截至 2024 年，万载县共有花炮生产企业 170 家、贸易企业 86 家、上下游企业 200 余家，全县花炮总产值达到 233 亿元，2021-2023年连续三年保持 20% 以上增速。',
          scaleDesc2:
            '相关从业人员逾 15 万人，约占全县总人口的四分之一，每年为当地创造约 40 亿元工资性收入，贡献全县 30% 以上的财政收入，是名副其实的富民支柱产业。',
          market: '市场布局',
          marketDesc1:
            '万载花炮共有 4000 多个规格品种，涵盖鞭炮、玩具烟花、组合烟花等 9 大类（按传统用途分类），产品畅销全国及出口 40 多个主要国家和地区。',
          marketDesc2:
            '自 20 世纪 60 年代起，万载花炮便敲开了海外大门，如今出口产品包含 11 大类近千个种类，远销美洲、欧洲、东南亚等地区。2024 年，全县烟花出口额达 2.64 亿美元，同比增长 6.5%。',
        ...
        techUpgrade: {
          title: '技术升级与创新',
          desc1:
            '近年来，万载县委、县政府树牢 "安全是基础、发展是目的、品牌是方向" 的理念，坚持花炮产业 "一个不动摇、三个更" 工作思路，深入推进花炮产业转型升级。',
          desc2:
            '经过多轮国标整改提升，万载花炮产业的生产自动化、智能化水平显著提升，产品安全性能更有保障。当地企业不断探索创新，比如万载县汇鑫源礼花制造有限公司作为国家高新技术专精特新企业，研制出行业领先的安全环保的无钾无硫礼花弹技术，成为全球迪士尼乐园与环球影城的主要供应商，2024 年出口额达 6000 多万元。',
          desc3:
            '2024 年，万载县花炮产业集群入选江西省中小企业特色产业集群，形成了集原材料生产到半成品加工、成品生产、运输包装、会展培训、检测评价、研发燃放等较为完善的产业链。',
        },
        cultureTourism: {
          title: '文旅融合',
          desc1:
            '万载以千年花炮技艺为钥，首创 "烟花 + 古城" 模式，将烟花文化与文旅产业深度融合，打造了独具特色的文旅品牌"焰火之吻"。',
          desc2:
            '万载古城景区作为国家 AAAA 级旅游景区，以全国最大的赣派多姓氏古祠堂集群为基础，植入焰火表演等当地特色文化，形成了 "每周六来万载看烟花" 等文旅品牌 IP。',
          desc3:
            '万载古城成功入选首批 "国家级夜间文旅消费集聚区"，其 "烟花与文化旅游产业融合发展夜游经济" 入选全国文化遗产旅游百强案例。2024 年上半年，万载全县接待游客 1011.8 万人次，实现旅游综合收入 74.97 亿元，同比分别增长 24.9%、24%。',
        },
        future: {
          title: '未来展望',
          desc1:
            '面向未来，万载将继续聚焦花炮产业的高质量发展，一方面借助 "一带一路" 政策加强与沿线国家的贸易合作，拓展海外市场，加快烟花爆竹产业外贸转型升级；另一方面，持续推动技术创新和产业升级，打造更多高端烟花产品，同时深化文旅融合，让千年焰火在新时代绽放出更加璀璨的光彩。',
          desc2:
            '万载正聚力打造名副其实的 "中国花炮之乡"，通过产业升级、文化传承和文旅融合，实现烟花产业的可持续发展，为当地经济社会发展注入新的动力。',
        },
      },
    },
    routes: {
      ...
      routes: {
        ancient: '古城文化之旅',
        ancientMorning:
          '上午：抵达万载，游览万载古城，参观古祠堂群、历史文化馆、宗祠文化馆、国学文化馆',
    ...
    viewingSpots: {
      ...
      spots: {
        ancientCity: '万载古城',
        ancientCityDesc1:
          '万载古城是最佳的烟花观赏地点之一，每周六晚8:00准时上演"焰火之吻"免费烟花秀，时长30分钟。古城的青石板路、马头墙与璀璨烟花交相辉映，构成了一幅美丽的画卷。',
        ancientCityViewing: '绿阴广场、沿河长廊、古城观景台',
        ancientCityTransport: '位于万载县城中心，可乘坐公交或出租车抵达',
        longhuPark: '龙湖公园',
        longhuParkDesc1:
          '龙湖公园是万载县城的城市公园，湖面宽阔，视野开阔，是观赏烟花的理想场所。烟花在湖面的倒影更加美丽动人，给人以双重的视觉享受。',
    ...
    merchant: {
      ...
      merchants: {
        caiTian: {
          ...
          category: '艺术燃放',
          description:
            '万载县彩天烟花艺术燃放制作有限公司是国内烟花行业兼具顶级生产制造能力与专业艺术燃放实力的标杆企业，以"烟花文旅演艺创意开拓者"为发展目标。',
        ...
        qianNian: {
          ...
          category: '食品加工',
          description:
            '江西万载千年食品有限公司是万载县食品加工行业的龙头企业，成立于2001年，专注江西传统特色食品研发生产，拥有1400多年历史传承。',
        ...
        tailin: {
          ...
          category: '鞭炮制造',
          description:
            '泰麟花炮坐落于世界花炮金三角的核心重镇——万载县双桥镇，以"精品小排炮"为承诺，20余年专注烟火制造。公司占地428亩，五区协调生产，产品涵盖百余种规格，精准匹配不同市场需求。',
      ...
      reviews: {
        zhang: {
          author: '张先生',
          content:
            '彩天艺术焰火的焰火表演效果非常震撼，创意十足！作为合作方，对他们的专业水准和无钾无硫环保技术印象深刻，强烈推荐！',
          date: '2026-2-26',
        },
        wang: {
          author: '王先生',
          content:
            '千年公司的南酸枣糕口感非常好，天然酸甜，风味独特。葛粉和百合粉品质也很不错，值得推荐！',
          date: '2025-12-08',
        },
        li: {
          author: '李先生',
          content:
            '泰麟花炮的鞭炮声音清脆响亮，品质非常好！而且公司规模大、资质全，是值得信赖的合作伙伴。',
          date: '2026-02-20',
        },
      },
      apply: {
        title: '商户入驻申请',
        subtitle: '填写以下信息，审核通过后即可管理店铺和发布优惠券',
        storeName: '店铺名称',
        category: '分类',
        dining: '餐饮',
        lodging: '民宿',
    ...
    footer: {
      about: '关于焰境·万载',
      aboutDesc:
        '焰境·万载是一个展示江西省万载县烟花文化、非遗传承、美食特产和旅游风光的现代化文旅展示网站。',
      quickLinks: '快速链接',
      friendLinks: '友情链接',
      contact: '联系我们',
    ...
    firework: {
      ...
      saveDialog: {
        title: '保存烟花配方',
        description: '将保存当前所有引擎设置和录制的时间线，生成分享链接供他人观看回放',
        placeholder: '给你的烟花起个名字...',
        saving: '保存中...',
        save: '保存',
        cancel: '取消',
        success: '保存成功！🎆',
      ...
      hint: '💥 点击画布发射烟花 | ⚙ 齿轮调整类型 | 💾 保存配方',
      error: {
        timeout: '引擎初始化超时，请刷新页面重试',
      },
      simSpeed: '模拟速度',
      longExposure: '长曝光',
      longExposureHint: '粒子轨迹保留更久，适合拍照录屏。有背景图时效果更佳',
      launchSequence: '发射序列',
      seqRandom: '随机',
      seqTwoRandom: '双发',
      seqTriple: '三连',
      ...
      customColor: '自定义颜色',
      recordMode: '录制模式',
      recording: '录制中: {count} 发 / {time}',
      clearRecording: '清空',
      advancedParams: '高级参数',
      advancedHint: '高级参数可能影响性能',
      gravity: '重力',
    ...
    aiChat: {
      ...
      subtitle: '傩文化守护灵',
      welcome:
        '傩愿与你相遇！我是花傩，万载的AI守护灵～可以带你了解烟花文化、非遗传承、美食特产、旅游线路……有什么想知道的尽管问我！',
      placeholder: '请输入您的问题...',
      quickQ1: '🔥 万载烟花有什么特别的？',
      quickQ2: '🏛️ 带我去看非遗文化～',
      quickQ3: '🗺️ 帮我推荐一条旅游线路',
      quickQ4: '🍜 万载有什么好吃的？',
      thinking: '正在思考...',
      error: '抱歉，服务暂时不可用',
        ...
        team: {
          ...
          members: {
            ...
            member6: {
              ...
              role: '智能赋能助手',
              description:
                '基于前沿人工智能技术，为团队提供智能创作支持与效率赋能，协助内容生成、技术优化与创意策划，推动项目数字化转型与智能化升级。',
            },
          },
        },
        background: {
          ...
          originTitle: '创立初衷',
          originDesc:
            '焰境·万载由一群热爱家乡文化的北京高校在读生发起，我们希望通过现代技术手段，让更多人了解万载这座拥有千年烟花文化的小城。',
          goalTitle: '推广目标',
          goalDesc:
            '我们的目标是用AI技术赋能万载文旅，通过互联网传播万载的独特魅力，吸引更多游客前来体验花炮之乡的璀璨风情，同时助力当地文旅产业高质量发展。',
        },
        mission: {
          title: '使命与愿景',
          missionTitle: '我们的使命',
          missionDesc:
            '传承与弘扬万载千年烟花文化，让每一位访客都能感受到这座城市的热情与魅力。我们致力于打造最全面的万载文旅信息平台，让游客轻松规划行程，深度体验当地文化。',
          visionTitle: '我们的愿景',
          visionDesc:
            '成为万载文旅数字化转型和新媒体矩阵构建的标杆，与当地企业、政府部门紧密合作，让"焰境·万载"成为国内外游客了解万载的重要入口。未来，我们计划将这一发展路径从万载推广开来，打造成为县域经济实现破局发展的关键方案。',
        },
        timeline: {
          title: '发展历程',
          events: {
            event1: {
              ...
              title: '项目启动',
              description:
                '团队正式组建，完成项目可行性分析与市场调研，确立平台定位与发展战略，启动技术研发准备工作。',
            },
            event2: {
              date: '2026年1-2月',
              title: '产品研发',
              description:
                '完成平台原型设计与核心功能开发，采用Vue 3 + Tailwind CSS前沿技术栈，构建高性能用户体验框架，实现非遗文化、美食特产等核心模块上线。',
            },
            event3: {
              date: '2026年2月末',
              title: '正式发布',
              description:
                '平台正式上线运营，面向公众开放访问，完成首轮用户测试与功能优化，确立品牌形象与市场定位。',
            },
            event4: {
              date: '2026年4月',
              title: '品牌运营',
              description:
                '启动新媒体矩阵运营战略，构建微信公众号、抖音等多元化宣传渠道，持续拓展用户触达路径，提升平台品牌影响力。',
            },
          },
        },
        partners: {
    ...
    docs: {
      library: '万载文库',
      subtitle: '攻略指南、人文故事、实用说明，读懂万载的一切',
      back: '返回文库',
      empty: '暂无文档',
      notFound: '文档未找到',
      all: '全部',
  ...
  en: {
    ...
    nav: {
      ...
      merchant: 'Merchants',
      about: 'About Us',
      clusterCulture: 'Wanzai Culture',
      clusterInteractive: 'Interactive',
      clusterBusiness: 'Business',
      aiHuaNuo: 'AI Hua Nuo',
      digitalFirework: 'Digital Fireworks',
      fireworkRankings: 'Firework Rankings',
    ...
    home: {
      hero: {
        ...
        subtitle:
          'Explore the thousand-year fireworks culture, experience intangible heritage charm, taste local delicacies, and enjoy Wanzai scenery',
    ...
    culture: {
      ...
      sections: {
        fireworks: {
          ...
          desc2:
            'The history of Wanzai fireworks can be traced back to the Tang Dynasty, flourishing in the Song Dynasty, and developing over a thousand years. During the Daoguang period of the Qing Dynasty, Wanzai fireworks had already "circulated throughout the north and south, with merchants constantly coming and going"; during the Guangxu period, local "men and women of all ages relied on this for work", with high-quality and affordable products sold to Guangdong, Fujian and other provinces.',
          desc3:
            'Today, Wanzai fireworks have over 4000 specifications and varieties, covering 9 major categories including firecrackers, toy fireworks, and assembled fireworks. Products sell well throughout China and are exported to more than 40 countries and regions in Europe, America, and Southeast Asia.',
        },
        deshenggu: {
          title: 'Desheng Drum',
          desc1:
            'Desheng Drum is a traditional folk drum music in Wanzai County, originating from the Northern Song Dynasty, mainly based on historical events of the Tang Dynasty\'s pacification of the "An Lushan Rebellion". Desheng Drum is famous for its vigorous and passionate atmosphere, uniform rhythm, and colorful performance forms.',
          desc2:
            'Desheng Drum performances usually consist of dozens of performers, using instruments such as big drums, small drums, suona, gongs, and cymbals. The performance features diverse formations and crisp drum rhythms, fully showcasing the heroic spirit and unity of Wanzai people.',
          desc3:
            'Today, Desheng Drum has become an important cultural brand in Wanzai County, often performed at various cultural activities and festival celebrations, deeply loved by the public.',
        },
        kaiKouNuo: {
          title: 'Wanzai Kai Kou Nuo',
          desc1:
            'Wanzai Kai Kou Nuo, also known as "Tiao Xiao", is a distinctive folk cultural activity for exorcising ghosts, seeking blessings and safety, and entertaining gods and people. It originated in the late Yuan and early Ming Dynasty, with a history of over 600 years.',
          desc2:
            'Different from other Nuo dance forms, Kai Kou Nuo requires singing for every character, including singing, acting, reciting, and fighting, but mainly singing. The music runs through with percussion, preserving a simple rural flavor.',
          desc3:
            'In June 2008, "Wanzai Kai Kou Nuo" was selected into the second batch of National Intangible Cultural Heritage list.',
        },
        xiaBu: {
          title: 'Xia Bu Weaving',
          desc1:
            'Xia Bu weaving technique is a traditional handicraft in Wanzai County, with production tracing back to the late Eastern Jin Dynasty, having a history of over 1600 years. In 2009, Wanzai Xia Bu weaving technique was listed in the third batch of National Intangible Cultural Heritage.',
          desc2:
            'Wanzai Xia Bu uses ramie as raw material, going through four processes: warp sizing, mounting, and weaving. Xia Bu is light, breathable, and highly absorbent, making it an ideal summer clothing fabric.',
          desc3:
            'Today, Wanzai Xia Bu has become a specialty product of Jiangxi Province, sold domestically and overseas, deeply loved by consumers.',
        },
        zhiPeng: {
          title: 'Zhipeng Folk Songs',
          desc1:
            'Zhipeng Folk Songs are traditional folk music in Wanzai County, originating from the Ming Dynasty, with a history of over 500 years. They are songs created by paper-making workers during labor, with rich content and diverse forms.',
          desc2:
            'The songs revolve around paper-making processes such as bamboo collecting, retting, and drying, blending themes of labor hardships, romantic love, and harvest expectations. The melodies are beautiful, with lively rhythms, and have a rich local flavor.',
          desc3:
            'In March 2007, Zhipeng Folk Songs were listed in the Jiangxi Province Intangible Cultural Heritage list, becoming one of the important cultural heritages of Wanzai County.',
        },
      },
    },
    food: {
    ...
    industry: {
      ...
      sections: {
        history: {
          ...
          desc2:
            'In modern times, Wanzai fireworks have also left a glorious mark: In April 1936, Jiangxi Province held the Hangzhou Transportation Exhibition, where Wanzai\'s "Tongxinmao" and "Zhenshengwan" firecrackers both received awards from the Zhejiang-Jiangxi Special Products Association; major events such as the Beijing Olympics, Shanghai World Expo, and National Day celebrations have all featured the brilliant light of Wanzai fireworks.',
        },
        currentStatus: {
          title: 'Industry Status',
          scale: 'Industry Scale',
          scaleDesc1:
            'As of 2024, Wanzai County has 170 fireworks production enterprises, 86 trading enterprises, and over 200 upstream and downstream enterprises. The total fireworks output value reaches 23.3 billion yuan, maintaining a growth rate of over 20% for three consecutive years from 2021 to 2023.',
          scaleDesc2:
            "More than 150,000 people are employed in related industries, accounting for about a quarter of the county's total population. It creates about 4 billion yuan in wage income annually and contributes over 30% of the county's fiscal revenue, making it a truly prosperous pillar industry.",
          market: 'Market Distribution',
          marketDesc1:
            'Wanzai fireworks have over 4,000 specifications and varieties, covering 9 major categories including firecrackers, toy fireworks, and assembled fireworks (by traditional use classification). Products sell well throughout China and are exported to more than 40 major countries and regions.',
          marketDesc2:
            "Since the 1960s, Wanzai fireworks have opened the overseas market. Today, export products include nearly 1,000 varieties in 11 major categories, sold to America, Europe, Southeast Asia and other regions. In 2024, the county's fireworks export reached 264 million USD, a year-on-year increase of 6.5%.",
        ...
        future: {
          ...
          desc2:
            'Wanzai is striving to build a true "Hometown of Chinese Fireworks". Through industry upgrade, cultural inheritance, and cultural tourism integration, it achieves sustainable development of the fireworks industry, injecting new momentum into local economic and social development.',
        },
      },
    },
    routes: {
      ...
      routes: {
        ...
        ancientMorning:
          'Morning: Arrive in Wanzai, visit Wanzai Ancient City, explore the ancient clan halls, history museum, clan culture museum, and Chinese classics museum',
        ancientNoon: 'Noon: Taste Wanzai specialty cuisine at Wanzai Kitchen (Ancient City Branch)',
        ancientAfternoon:
          'Afternoon: Experience Xia Bu weaving craftsmanship, watch Desheng Drum performance',
        ancientEvening:
          'Evening: Watch "Kiss of Fire" fireworks show, enjoy Wanzai night market delicacies',
        mountain: 'Mountain & Water Cultural Tour',
        mountainMorning:
          'Morning: Visit Zhushan Cave scenic area, Wanzai Henghui Art Agriculture Scenic Area',
        mountainNoon: 'Noon: Taste authentic farmhouse cuisine, experience Wanzai flavors',
        mountainAfternoon:
          'Afternoon: Explore Jiulong Primitive Forest, experience nature through rafting',
        mountainEvening:
          'Evening: Watch fireworks culture festival at Longhu Park, enjoy the "meteors" falling in the night',
        red: 'Red Culture Tour',
        redMorning:
          'Morning: Visit Hunan-Hubei-Jiangxi Revolutionary Memorial Hall, Wanzai Revolutionary Martyrs Memorial Hall',
        redNoon: 'Noon: Experience Red Army meal, feel the spirit of predecessors',
        redAfternoon:
          'Afternoon: Visit Xianyuan Hunan-Hubei-Jiangxi Revolutionary Base Site Group, retrace the Red Army trail',
        redEvening:
          'Evening: Enjoy intangible heritage performances, watch fireworks show, taste Wanzai specialty cuisine',
      },
    },
    viewingSpots: {
      hero: {
      ...
      spots: {
        ...
        ancientCityDesc1:
          'Wanzai Ancient City is one of the best fireworks viewing locations. Every Saturday at 8:00 PM, the "Kiss of Fire" free fireworks show starts promptly, lasting 30 minutes. The ancient city\'s bluestone paths, horse-head walls, and brilliant fireworks create a beautiful picture.',
        ...
        longhuParkDesc1:
          'Longhu Park is an urban park in Wanzai county with a wide lake surface and open view, making it an ideal place to view fireworks. The reflections of fireworks on the lake surface are even more beautiful, providing a double visual experience.',
      ...
      tips: {
        ...
        time2:
          'Major holidays (such as Spring Festival, Lantern Festival, National Day) or Fireworks Culture Festival',
        ...
        notice2:
          'Pay attention to safety, stay away from fireworks launch points, choose open areas',
    ...
    merchant: {
      ...
      merchants: {
        caiTian: {
          ...
          description:
            'Wanzai Caitian Fireworks Art Performance Co., Ltd. is a benchmark enterprise in the domestic fireworks industry with top-level manufacturing capabilities and professional art display expertise, aiming to be a "creative pioneer in fireworks cultural tourism performances."',
          products: [
            'Art Fireworks Display',
            'Cultural Tourism Performance Planning',
            'Fireworks Cultural Products',
          ],
          advantages: [
            'National Class A Fireworks Display Qualification',
            'Disney/Universal Studios Supplier',
            'Professional Display Team 30+ Years',
          ],
        ...
        qianNian: {
          ...
          description:
            'Jiangxi Wanzai QianNian Food Co., Ltd. is a leading enterprise in Wanzai food processing industry, founded in 2001, specializing in Jiangxi traditional specialty food R&D and production with over 1400 years of historical heritage.',
          products: ['South Wild Jujube Cake', 'Kudzu Products', 'Lily Products'],
          advantages: [
            'China Famous Trademark',
            'Provincial-Level Agricultural Industrialization Leading Enterprise',
            'Jiangxi Province Famous Brand',
          ],
      ...
      reviews: {
        zhang: {
          author: 'Mr. Zhang',
          content:
            'The fireworks display by Caitian Art Fireworks was absolutely stunning and full of creativity! As a partner, I was impressed by their professional standards and potassium-free, sulfur-free environmental protection technology. Highly recommended!',
          date: '2026-2-26',
        },
        wang: {
          author: 'Mr. Wang',
          content:
            "QianNian company's South Wild Jujube Cake has a very good taste, natural sweet and sour with unique flavor. The kudzu powder and lily powder are also of great quality, highly recommended!",
          date: '2025-12-08',
        },
        li: {
          author: 'Mr. Li',
          content:
            "Tailin Fireworks' firecrackers have crisp and loud sounds with excellent quality! Moreover, the company has large scale and complete qualifications, making it a trustworthy partner.",
          date: '2026-02-20',
        },
      },
      apply: {
        ...
        subtitle:
          'Fill in the details below. Once verified, you can manage your store and publish coupons.',
        ...
        success: 'Application submitted. Awaiting review!',
    ...
    footer: {
      about: 'About Wanzai',
      aboutDesc:
        'Wanzai is a modern cultural tourism website showcasing the fireworks culture, intangible heritage, local delicacies and tourism scenery of Wanzai County, Jiangxi Province.',
    ...
    common: {
      ...
      videoHint:
        'Video playback may consume a lot of data. Please play in WiFi environment as much as possible.',
    ...
    auth: {
      ...
      huaNuoMessages: {
        save_firework: "I'll save this firework forever for you~ Just sign up with me!",
        collect_firework: 'Sign up with me to collect~ May your love be forever remembered!',
        get_coupon: 'Sign up with me first, so the coupon is yours~',
        default: 'Sign up with HuaNuo to unlock more features~',
      },
    },
    admin: {
      ...
      newToday: 'New Today',
      loadError: 'Failed to load. Make sure you are logged in as admin.',
      addDoc: 'New Doc',
      editDoc: 'Edit Doc',
      slug: 'Slug',
      docTitle: 'Title',
      ...
      mdImport: 'Import MD',
      slugHint: 'Leave empty to generate from title',
    },
    profile: {
      pageTitle: 'Profile',
      ...
      save: 'Save',
      saved: 'Saved',
      loadError: 'Failed to load. Make sure you are logged in.',
    },
    merchantDashboard: {
    ...
    firework: {
      ...
      share: {
        loading: 'Loading firework recipe...',
        notFound: 'Recipe Not Found',
        createOwn: 'Create your own',
        by: 'By: ',
        views: ' views',
        copyLink: 'Copy Link',
        createOwn2: 'Create Your Own',
        openInWorkshop: 'Open in Firework Workshop',
        configTitle: 'Recipe Config',
        visitor: 'Visitor',
      ...
      saveDialog: {
        title: 'Save Firework Recipe',
        description:
          'Saves all engine settings and recorded timeline, generates a share link for others to watch the replay',
        placeholder: 'Name your firework...',
        saving: 'Saving...',
        save: 'Save',
        cancel: 'Cancel',
        success: 'Saved! 🎆',
      ...
      hint: '💥 Click canvas to launch | ⚙ Settings | 💾 Save recipe',
      error: {
        timeout: 'Engine init timeout, please refresh',
      },
      simSpeed: 'Sim Speed',
      longExposure: 'Long Exposure',
      longExposureHint:
        'Particle trails persist longer, ideal for screenshots. Best with background image',
      launchSequence: 'Launch Sequence',
      seqRandom: 'Random',
      seqTwoRandom: 'Two Random',
      seqTriple: 'Triple',
      seqPyramid: 'Pyramid',
      seqSmallBarrage: 'Barrage',
      textPresets: {
        label: 'Text Presets',
      ...
      recording: 'Recording: {count} shots / {time}',
      clearRecording: 'Clear',
      advancedParams: 'Advanced Params',
      advancedHint: 'Advanced params may affect performance',
      gravity: 'Gravity',
      particleDensity: 'Particle Density',
      sparkAmount: 'Spark Amount',
    },
    leaderboard: {
      title: 'Firework Leaderboard',
      subtitle: 'Top firework recipes from the community',
      back: 'Back to Firework',
    },
    aiChat: {
      title: 'Hua Nuo',
      subtitle: 'Guardian Spirit of Nuo',
      welcome:
        "Nuo blessings upon you! I'm Hua Nuo, Wanzai's AI guardian spirit~ I can show you fireworks culture, heritage, food, travel routes... Ask me anything!",
      placeholder: 'Type your question...',
      quickQ1: '🔥 What makes Wanzai fireworks special?',
      quickQ2: '🏛️ Show me the cultural heritage~',
      quickQ3: '🗺️ Plan a travel route for me',
      quickQ4: "🍜 What's delicious in Wanzai?",
      thinking: 'Thinking...',
        ...
        team: {
          ...
          members: {
            ...
            member6: {
              ...
              description:
                'Based on cutting-edge artificial intelligence technology, provides intelligent creative support and efficiency empowerment for the team, assists in content generation, technical optimization and creative planning, driving project digital transformation and intelligent upgrade.',
            },
          },
        },
        background: {
          ...
          originTitle: 'Origin',
          originDesc:
            'WhizzZest was initiated by a group of students from Beijing universities who love their hometown culture. We hope to use modern technology to help more people learn about Wanzai, a small city with millennium fireworks culture.',
          goalTitle: 'Promotion Goals',
          goalDesc:
            "Our goal is to empower Wanzai tourism with AI technology, spreading Wanzai's unique charm through the internet, attracting more tourists to experience the brilliant fireworks culture, while helping the local tourism industry develop with high quality.",
        },
        mission: {
          title: 'Mission & Vision',
          missionTitle: 'Our Mission',
          missionDesc:
            "Preserve and promote Wanzai's millennium fireworks culture, let every visitor feel the passion and charm of this city. We are dedicated to creating the most comprehensive Wanzai tourism information platform, helping tourists easily plan their trips and deeply experience local culture.",
          visionTitle: 'Our Vision',
          visionDesc:
            'Become a benchmark for Wanzai\'s digital tourism transformation and new media matrix construction, working closely with local enterprises and government departments to make "WhizzZest" an important entry point for domestic and international tourists to learn about Wanzai. In the future, we plan to expand this development path from Wanzai, creating a key solution for county-level economies to achieve breakthrough development.',
        },
        timeline: {
          ...
          events: {
            event1: {
              ...
              description:
                'Team officially formed, completed project feasibility analysis and market research, established platform positioning and development strategy, initiated technical R&D preparation.',
            },
            event2: {
              date: 'January-February 2026',
              title: 'Product Development',
              description:
                'Completed platform prototype design and core feature development, adopted Vue 3 + Tailwind CSS cutting-edge tech stack, built high-performance user experience framework, launched core modules including intangible heritage and local delicacies.',
            },
            event3: {
              date: 'Late February 2026',
              title: 'Official Release',
              description:
                'Platform officially launched for operation, opened to public access, completed first-round user testing and feature optimization, established brand image and market positioning.',
            },
            event4: {
              date: 'April 2026',
              title: 'Brand Operations',
              description:
                'Initiated new media matrix operation strategy, built diversified promotional channels including WeChat public account and Douyin, continuously expanded user reach pathways, enhanced platform brand influence.',
            },
          },
        },
        partners: {
    ...
    docs: {
      library: 'Wanzai Library',
      subtitle: 'Guides, stories, and useful info — everything about Wanzai',
